...
namespace ComicBooksLoanAppAPI.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        private readonly comicbooksloanDbContext _db;

        /// <summary>
        /// Initializes a new instance of the MessagesController class.
        /// </summary>
        public MessagesController(IMessageService messageService, ILogger<MessagesController> logger, comicbooksloanDbContext db)
        {
