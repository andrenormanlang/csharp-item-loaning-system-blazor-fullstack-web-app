...
namespace ComicBooksLoanAppAPI.Migrations
{
    ...
    [Migration("20251208101015_UpdateForLocalMeetupsInSkane")]
    partial class UpdateForLocalMeetupsInSkane
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ComicBooksLoanAppAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AverageRating = 4.9m,
                            Biography = "British expat living in Malmö since 2018. Started reading comics in 1975. Took a break in the 90s and just getting back into it. Love sharing the classics I grew up with through this lending library. Happy to meet up anywhere in central Malmö!",
                            City = "Malmö",
                        ...
                        new
                        {
                            Id = 2,
                            AverageRating = 5.0m,
                            Biography = "Canadian expat, former bookstore owner. Passionate about mature, literary comics. The Vertigo line changed everything for me. Living in Lund near the university. Can meet in Lund or Malmö.",
                            City = "Lund",
                        ...
                        new
                        {
                            Id = 3,
                            AverageRating = 4.8m,
                            Biography = "American expat in Helsingborg. Have been collecting X-Men since Claremont took over. Own nearly every issue from Giant-Size #1 through the 90s. Happy to share the classics! Usually available for meetups in Helsingborg centrum.",
                            City = "Helsingborg",
                        ...
                        new
                        {
                            Id = 4,
                            AverageRating = 4.9m,
                            Biography = "Spanish expat, been in Malmö for 10 years. Grew up on O'Neil/Adams Batman and the classic Teen Titans. Still think the 70s-80s were the golden era of DC storytelling. Live in Västra Hamnen, happy to meet anywhere in Malmö.",
                            City = "Malmö",
                        ...
                        new
                        {
                            Id = 5,
                            AverageRating = 4.7m,
                            Biography = "Swedish-American, grew up in the States but moved to Sweden for university and stayed. Was there when the indie revolution started. Own runs of many titles that launched careers. Love sharing these overlooked gems. Living near Lund C, easy to meet up!",
                            City = "Lund",
