        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReadingFocus = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredMeetupMethod = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SuggestedMeetupLocation = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeetupLocation = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    MeetupDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReturnMeetupLocation = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ReturnMeetupDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommunicationGood = table.Column<bool>(type: "bit", nullable: false),
                    MeetupExperience = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
